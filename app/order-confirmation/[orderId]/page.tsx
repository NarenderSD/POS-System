...
export default function OrderConfirmationPage() {
  ...
  const orderId = typeof window !== 'undefined' ? window.location.pathname.split('/').pop() : undefined
...
================================
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-2 sm:p-4">
      <div className="container mx-auto max-w-2xl px-0 sm:px-4">
        <div className="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-auto" style={{maxHeight: '90vh'}}>
          {/* Success Animation */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 print:hidden">
            ...
            {order.orderType === "dine-in" && order.status !== "completed" && (
              <Button onClick={handleClearTable} variant="default" className="flex-1 bg-green-600 text-white">
                {language === "hi" ? "टेबल साफ़ करें (बिल भुगतान)" : "Clear Table (Bill Paid)"}
              </Button>
            )}
          </div>
